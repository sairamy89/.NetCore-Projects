...
#else
string name, object value = null, OracleDbType? dbType = null, ParameterDirection? direction = null, int? size = null, OracleCollectionType? collectionType = OracleCollectionType.None
#endif
)
	{
		parameters[Clean(name)] = new ParamInfo() { Name = name, Value = value, ParameterDirection = direction ?? ParameterDirection.Input, DbType = dbType, Size = size, CollectionType = collectionType };
	}
	...
	protected void AddParameters(IDbCommand command, SqlMapper.Identity identity)
	{
		...
		foreach (var param in parameters.Values)
		{
			...
			if (param.CollectionType != null && param.CollectionType != OracleCollectionType.None)
			{
